...
contest_ext_crd_hd_report[contest_ext_crd_hd_report$QUERY_ORG=="A"|contest_ext_crd_hd_report$QUERY_ORG=="B",]
...
contest_ext_crd_hd_report$QUERY_ORG<-as.factor(model_rf)
head(contest_ext_crd_hd_report)
nrow(contest_ext_crd_hd_report)
##与基础表合并
union1<-left_join(basic,contest_ext_crd_hd_report[,-2])
table(union9$QUERY_ORG)
contest_basic_test[contest_basic_test$REPORT_ID=="7126184"|contest_basic_test$REPORT_ID=="8710845",]
###分为测试集和训练集###
